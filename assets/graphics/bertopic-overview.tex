...
\begin{tikzpicture}
  ...
  \draw (0, -2) rectangle (4,-1) node[pos=.5] {Raw Documents};

  \draw (0,0) rectangle (4,1) node[pos=.5] {Lorem ipsum};
  ...
  \fill[color=red] (12+8.5, 4) circle (.15) node {};
  \fill[color=red] (12+8.5, 5) circle (.15) node {};
  \fill[color=red] (12+7.5, 5) circle (.15) node {};
  \fill[color=red] (12+7.5, 3) circle (.15) node {};
  \fill[color=red] (12+8.155, 3.5) circle (.15) node {};
  \fill[color=red] (12+8.5, 2.5) circle (.15) node {};
  \fill[color=red] (12+7.5, 1) circle (.15) node {};
  \fill[color=red] (12+8.155, 1.5) circle (.15) node {};

  \fill[color=blue] (16+7.5, 2.5) circle (.15) node {};
  \fill[color=blue] (16+6.5, 5) circle (.15) node {};
  \fill[color=blue] (16+7.5, 4) circle (.15) node {};
  \fill[color=blue] (16+7.5, 3) circle (.15) node {};
  \fill[color=blue] (16+6.5, 3.5) circle (.15) node {};
  \fill[color=blue] (16+8.5, 2.5) circle (.15) node {};
  \fill[color=blue] (16+6.5, 2) circle (.15) node {};
  \fill[color=blue] (16+7.5, 1) circle (.15) node {};
